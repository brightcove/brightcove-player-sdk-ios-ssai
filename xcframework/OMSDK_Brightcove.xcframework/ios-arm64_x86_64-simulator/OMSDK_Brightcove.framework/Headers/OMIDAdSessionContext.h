 ...
 */
@interface OMIDBrightcoveAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDBrightcovePartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDBrightcovePartner *)partner
                               ...
                               resources:(NSArray<OMIDBrightcoveVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
