 ...
 */
@interface OMIDBrightcoveAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDBrightcoveAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDBrightcoveVASTProperties *_Nonnull)vastProperties
