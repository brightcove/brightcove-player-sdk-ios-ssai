 ...
 */
@interface OMIDBrightcoveAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDBrightcoveAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDBrightcoveAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDBrightcoveAdSessionContext *)context
